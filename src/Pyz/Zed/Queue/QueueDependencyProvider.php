...
//storage
            AntelopeStorageConfig::ANTELOPE_PUBLISH_STORAGE_QUEUE => new EventQueueMessageProcessorPlugin(),
            AntelopeStorageConfig::ANTELOPE_SYNC_STORAGE_QUEUE => new SynchronizationStorageQueueMessageProcessorPlugin(),
            ];
    }
}
